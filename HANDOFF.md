...
| **55** | Piloto técnico Thinking MU sin escritura                                                                               | adaptador/seed UCP + tests                                           | 12/12 prendas disponibles en EUR, reparto mujer/hombre 6/6, composición obligatoria e imágenes de origen verificadas. Tags sólo desde algodón orgánico/cáñamo u otra fibra explícita. Store oculta y eco-score 0; pendiente allowlist live y gate Skimlinks.                                  |
...
33. **UCP Storefront limita `lookup_catalog` a 10 IDs**: los pilotos mayores deben dividir la consulta y validar después el conjunto completo. Nunca aceptar silenciosamente menos productos: puede indicar baja, stock agotado o deriva editorial.
...
| **B-7A** | 🟡 **Segundos merchants en los otros nichos**    | verificación Skimlinks + escritura/activación   | Woodendot está validado live. Thinking MU: adaptador/dry-run 12/12, pendiente allowlist live. Ambos siguen fuera de Cloud hasta el gate. Después: Native Union (`docs/merchant-sourcing-round-3.md`). |
...
- [ ] Woodendot: comprobar `woodendot.com` y deep linking en Skimlinks; el piloto de 12 y la imagen live están validados, pero seguirá fuera de Supabase hasta superar este gate y autorizar escritura/activación.
- [ ] Thinking MU: comprobar `thinkingmu.com` y deep linking en Skimlinks; no escribir ni activar el piloto aunque el dry-run pase hasta verificar este gate.
