...
| **58** | Piloto técnico Orbitkey sin escritura                                                                                  | adaptador/seed UCP + allowlist exacta                                | 10/10 accesorios disponibles para España en EUR y diez imágenes de origen válidas. Store oculta, no verificada y eco-score 0; programa directo bajo solicitud y ninguna fila Cloud sin autorización comercial/activación.                                                                     |
...
pnpm scripts:seed:orbitkey       # Shopify UCP; dry-run por defecto
