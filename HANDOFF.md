...
| **B-7A** | 🟡 **Segundos merchants en los otros nichos**    | verificación Skimlinks + escritura/activación   | Woodendot: adaptador, dry-run de 12, allowlist e imagen live verificados; no hay escritura Cloud. Pedir gate antes de `--write`. Después: Thinking MU → Native Union (`docs/merchant-sourcing-round-3.md`). |
