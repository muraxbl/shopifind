 ...
 *
 * Cache strategy: daily ISR, shared with the underlying Supabase fetch cache.
 * Product stock refreshes separately and Google does not need a minute-level
 * sitemap. After a deliberate merchant add/remove, validate the live XML as an
 * explicit release step before submitting it to Search Console.
 *
