 ...
 *
 * Cache strategy: ISR with a 60-second wall-clock revalidation, shared with
 * the underlying Supabase fetch cache. Merchant moderation must disappear
 * promptly from search discovery; Googlebot traffic is low enough that this
 * still avoids querying Supabase on every request.
 *
